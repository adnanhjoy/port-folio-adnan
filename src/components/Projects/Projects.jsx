...
import img1 from '../../assets/review/person1.jpg'
                ...
                <div className='w-4/5 mx-auto py-14'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mt-14'>
                        <div className="relative hover:opacity-100">
                            <img src={img1} alt="Avatar" className="w-full block h-auto" />
                            <div className=" absolute top-0 bottom-0 left-0 right-0 h-full w-full opacity-0 transition-[.5s] ease-in bg-black hover:opacity-75 cursor-pointer">
                                <div className='translate-x-[-50%] translate-y-[-50%] top-1/2 left-1/2 absolute flex flex-col'>
                                    <span className='text-white text-xl flex justify-center items-center gap-2 hover:bg-[#0f172a] py-1 px-3 rounded mb-3 border'>
                                        <TfiWorld></TfiWorld>
                                        <a>Live Site</a>
                                    </span>
                                    <span className='text-white text-xl flex justify-center items-center gap-2 hover:bg-[#0f172a] py-1 px-3 rounded mb-3 border'>
